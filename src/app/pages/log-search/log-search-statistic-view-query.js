(function() {
    ...
    angular
        ...
        .directive('logSearchStatisticViewQuery', logSearchStatisticViewQuery)
        .controller('StatisticViewQueryCtrl', StatisticViewQueryCtrl);
    //utils.factory('DataUtil', DataUtil);
    StatisticViewQueryCtrl.$inject = ['$scope', '$stateParams', '$log', '$q', '$sce', '$state', '$timeout', 'EsService', 'Principal', 'NgTableParams', '$uibModal'];

    function StatisticViewQueryCtrl($scope, $stateParams, $log, $q, $sce, $state, $timeout, EsService, Principal, NgTableParams, $uibModal) {
        var vm = this;
     ...
     * 统计页面
     */
    function logSearchStatisticViewQuery() {
        return {
            restrict: 'EA',
            controller: 'StatisticViewQueryCtrl',
            controllerAs: 'vm',
            templateUrl: 'app/pages/log-search/log-search-statistic-view-query.html',
