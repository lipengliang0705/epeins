(function () {
    ...
    SearchController.$inject = ['$uibModalInstance', 'transferData', '$rootScope', 'toastr','DateUtils','$filter','FilePlaceRecoveryService'];

    function SearchController($uibModalInstance, transferData, $rootScope, toastr,DateUtils,$filter,FilePlaceRecoveryService) {
        var vm = this;
        ...
        function tableloadAll() {
                ...
                "lis_test_a1-2019.08.28": {
                    ...
                    "mappings": {
                        "properties": {
                            ...
                            "key1": {"type": "keyword", "normalizer": "default"},
                            "key2": {"type": "text", "index": false},
                            "key3": {"type": "double"}
                        }
                    },
                    "settings": {
                        "index": {
                            "number_of_shards": "5",
                            "provided_name": "lis_test_a1-2019.08.28",
                            "creation_date": "1567011916128",
                            "analysis": {
                                "normalizer": {
                                    "default": {
                            ...
                            "uuid": "FDoQHtOvT7CjUSNGg-w5Sg",
                            "version": {"created": "7030099"}
                        }
                    }
                }
            }
            ...
            var params={
                snapshotName:transferData.snapshot+'*'
            }
