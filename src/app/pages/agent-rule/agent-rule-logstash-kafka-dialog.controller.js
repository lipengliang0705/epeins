(function() {
    ...
    angular
        ...
        .controller('AgentRuleLogStashKafkaDialogController', AgentRuleLogStashKafkaDialogController);

    AgentRuleLogStashKafkaDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AgentRule', 'DataSource', 'AgentHost', 'Category'];

    function AgentRuleLogStashKafkaDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AgentRule, DataSource, AgentHost, Category) {
        var vm = this;
