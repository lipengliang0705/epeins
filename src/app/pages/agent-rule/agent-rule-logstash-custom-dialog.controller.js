(function() {
    ...
    angular
        ...
        .controller('AgentRuleLogStashCustomDialogController', AgentRuleLogStashCustomDialogController);

    AgentRuleLogStashCustomDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AgentRule', 'DataSource', 'AgentHost', 'Category'];

    function AgentRuleLogStashCustomDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AgentRule, DataSource, AgentHost, Category) {
        var vm = this;
