(function() {
    ...
    angular
        ...
        .controller('AgentRuleLogStashTcpDialogController', AgentRuleLogStashTcpDialogController);

    AgentRuleLogStashTcpDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AgentRule', 'DataSource', 'AgentHost', 'Category'];

    function AgentRuleLogStashTcpDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AgentRule, DataSource, AgentHost, Category) {
        var vm = this;
