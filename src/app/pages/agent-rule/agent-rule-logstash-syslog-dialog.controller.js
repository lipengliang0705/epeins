(function() {
    ...
    angular
        ...
        .controller('AgentRuleLogStashSyslogDialogController', AgentRuleLogStashSyslogDialogController);

    AgentRuleLogStashSyslogDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AgentRule', 'DataSource', 'AgentHost', 'Category'];

    function AgentRuleLogStashSyslogDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AgentRule, DataSource, AgentHost, Category) {
        var vm = this;
