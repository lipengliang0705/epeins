(function() {
    ...
    angular
        ...
        .controller('AgentRuleLogStashFileDialogController', AgentRuleLogStashFileDialogController);

    AgentRuleLogStashFileDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AgentRule', 'DataSource', 'AgentHost', 'Category'];

    function AgentRuleLogStashFileDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AgentRule, DataSource, AgentHost, Category) {
        var vm = this;
