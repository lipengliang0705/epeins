(function() {
    ...
    angular
        ...
        .controller('AgentRuleLogStashDataDialogController', AgentRuleLogStashDataDialogController);

    AgentRuleLogStashDataDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AgentRule', 'DataSource', 'AgentHost', 'Category'];

    function AgentRuleLogStashDataDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AgentRule, DataSource, AgentHost, Category) {
        var vm = this;
