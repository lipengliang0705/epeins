(function() {
    ...
    app.controller("filePlaceAddController", filePlaceAddController);
    filePlaceAddController.$inject = ['$uibModalInstance', 'toastr', '$rootScope', '$state'];

    function filePlaceAddController($uibModalInstance, toastr, $rootScope, $state) {
        var vm = this;
